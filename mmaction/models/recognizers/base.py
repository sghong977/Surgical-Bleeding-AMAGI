...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    def average_clip(self, cls_score, num_segs=1):
        ...
        average_clips = 'prob' #self.test_cfg['average_clips']
    ...
    def forward(self, imgs, label=None, return_loss=True, infer_3d=False, **kwargs):
        """Define the computation performed at every call."""
        if infer_3d:
           
            return self.forward_3d_infer(imgs, **kwargs)
