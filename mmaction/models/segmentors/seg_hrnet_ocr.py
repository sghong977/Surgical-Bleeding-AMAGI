...
def get_seg_model(cfg, kfold=1, **kwargs):
    model = HighResolutionNet(cfg, **kwargs)
    if kfold ==  1:
        pre_path='split12_ocr_best.pth'
    elif kfold == 2:
        pre_path='split34_ocr_best.pth'
    else:
        pre_path='split56_ocr_best.pth'
    print("load seg model,", pre_path)

    model.init_weights(pre_path)
    # False
